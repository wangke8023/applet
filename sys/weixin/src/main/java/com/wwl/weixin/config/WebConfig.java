package com.wwl.weixin.config;

import com.wwl.weixin.interceptor.ThirdSessionInterceptor;
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(new ThirdSessionInterceptor(redisTemplate))
				...
				.excludePathPatterns("/weixin/api/ma/wxuser/login",
						...
						"/weixin/api/ma/orderrefunds/notify-refunds","/weixin/api/admin/getToken");//放行接口
	}
}
